...
const SaleTable = () => {
  ...
  // Format MMK
  const fmtMMK = (v) => v.toLocaleString("en-US") + " Ks";
        ...
        <table className="w-full text-sm text-left text-gray-700 table-fixed">
          <thead className="bg-gray-50 text-xs text-gray-500 uppercase tracking-wide">
            <tr>
              ...
              <th className="w-28 px-4 py-3 text-right">Full Price</th>
          ...
          <tbody className="divide-y divide-gray-100">
            {records.length === 0 ? (
              <tr>
                <td
                  colSpan={6}
                  className="px-4 py-4 text-sm text-gray-600 text-center"
                >
                  There is no data
                </td>
              </tr>
            ...
            {records.length > 0 && (
              <>
                ...
                <tr className="bg-indigo-50">
                  ...
                  <td className="px-4 py-3 text-right text-indigo-700 font-bold text-lg">
                    {fmtMMK(grandTotal)}
                  </td>
                  <td></td>
                </tr>
