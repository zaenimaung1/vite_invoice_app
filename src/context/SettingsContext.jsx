...
const TRANSLATIONS = {
  en: {
    ...
    dashboard: "Dashboard",
    dashboardSubtitle: "Choose a module to manage your products, sales, and sale_records.",
    modules: "Modules",
    overview: "Overview",
    totalProducts: "Total Products",
    todaySales: "Today Sales",
    todayRevenue: "Today Revenue",
    selectedDayRevenue: "Selected Day Revenue",
    ...
    rangeCustom: "Custom",
    rangeTo: "to",
    salesRangeLabel: "Sales",
    revenueRangeLabel: "Revenue",
    noSalesInRange: "No sales in selected range.",
    todayProductShare: "Today Product Share",
    todayProductShareDesc: "Based on today's voucher items",
    profitShare: "Profit Share",
    profitShareDesc: "Based on standard profit per item",
    chartType: "Chart Type",
    noSalesToday: "No sales recorded for today.",
    sale_record: "Sale records",
    sale: "Sale",
    product: "Product",
    addSale: "Add Sale",
    ...
    priceLabel: "Price",
    standardProfitLabel: "Standard Profit",
    ...
    preview: "Preview",
    export: "Export Excel",
    noVouchersToExport: "No vouchers to export.",
  },
  my: {
    export: "ဖိုင် ထုတ်ရန်",
    noVouchersToExport: "ထုတ်ရန်အတွက် ဘောင်ချာ မရှိပါ။",
    ...
    selectedDayRevenue: "ရွေးထားသောနေ့ ရရှိငွေ",
    ...
    rangeWeek: "ဒီအပတ်",
    rangeMonth: "ဒီလ",
    rangeCustom: "စိတ်ကြိုက်",
    rangeTo: "မှ",
    salesRangeLabel: "ရောင်းအား",
    revenueRangeLabel: "ဝင်ငွေ",
    noSalesInRange: "ရွေးထားသောကာလတွင် ရောင်းချမှတ်တမ်း မရှိပါ။",
    todayProductShare: "ယနေ့ ကုန်ပစ္စည်းရောင်းချမှု အချိုးအစား",
    todayProductShareDesc: "ယနေ့  ဘောင်ချာများပေါ် အခြေခံထားသည်",
    profitShare: "အမြတ် အချိုးအစား",
    profitShareDesc: "ကုန်ပစ္စည်း စံသတ်မှတ် အမြတ်ပေါ် အခြေခံထားသည်",
    chartType: "ပြဇယား အမျိုးအစား",
    noSalesToday: "ယနေ့အတွက် အရောင်းမှတ်တမ်း မရှိသေးပါ။",
    sale_record: "ဘောင်ချာ",
    sale: "အရောင်း",
    product: "ကုန်ပစ္စည်း",
    ...
    standardProfitLabel: "စံသတ်မှတ် အမြတ်",
